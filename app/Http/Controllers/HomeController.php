...
class HomeController extends Controller
{
    ...
    public function recoverPassword(Request $request){
        ...
        Mail::send('emails.users.recover-password', $data, static function ($message) use ($data) {
            $message->from('support@wglobalinvestment.com', 'Wealth Max Global Investment');
            $message->to($data['email'], $data['name']);
            $message->replyTo('support@wglobalinvestment.com', 'Wealth Max Global Investment');
    ...
    public function contactForm(Request $request){
        ...
        Mail::send('emails.contact-form', $data, static function ($message) use ($data) {
            $message->from('info@bit-farms.ltd', 'Wealth Max Global Investment');
            $message->to('support@wglobalinvestment.com', 'Wealth Max Global Investment');
            $message->replyTo('noreply@bit-farms.ltd', 'Wealth Max Global Investment');
